        ...
        <div class="constellation">
          ...
          <div class="constellation-fate">
            <div class="constellation-item">
              ...
              <div class="start-box">
                <div class="start-bg">
                  <img src="/static/star-white.png" class="star-white" v-for="(i, a) in [1, 1, 1, 1, 1]" :key="a">
                </div>
                <div class="start">
                  <img src="/static/star.png" class="star-white" v-for="(i, a) in all" :key="a">
                  <img src="/static/star-half.png" class="star-white" v-if="allhalf">
                </div>
              </div>
            </div>
            <div class="constellation-item">
              ...
              <div class="start-box">
                ...
                <div class="start">
                  <img src="/static/star.png" class="star-white" v-for="(i, a) in love" :key="a">
                  <img src="/static/star-half.png" class="star-white" v-if="lovehalf">
                </div>
              </div>
            </div>
            <div class="constellation-item">
              ...
              <div class="start-box">
                ...
                <div class="start">
                  <img src="/static/star.png" class="star-white" v-for="(i, a) in work" :key="a">
                  <img src="/static/star-half.png" class="star-white" v-if="workhalf">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="textarea zoomIn" :class="{zoomOut: isfadeOutUp}">
        <div class="edit-head">
          <div class="edit-head-title">
            <img src="/static/edit2.png" class="edit-icon">
            <span>编辑</span>
          </div>
          <img src="/static/close.png" class="close" @click="handelCloseEdit">
        </div>
...
<script>
  ...
  const publishday = 1577150609128;
